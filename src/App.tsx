            ...
            >
              ...
              <div className="p-6 border-t border-gray-100 bg-gray-50/50 flex gap-3">
                {(
                  ...
                  ((user.role === 'admin' || user.role === 'superuser') && selectedTicket.status === 'completed')
                ) && (
                  ...
                  <Button
                    ...
                    onClick={() => {
                      setEditTicket({
                        ...
                        assignedTechnicianIds: selectedTicket.assignedTechnicianIds || [],
                        attachmentUrl: selectedTicket.attachmentUrl || '',
                        attachmentName: selectedTicket.attachmentName || '',
                      });
